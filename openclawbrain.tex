...
\midrule
Vector top-k & TBD & TBD & TBD & TBD & TBD & TBD \\
Top-k + reranker & TBD & TBD & TBD & TBD & TBD & TBD \\
Pointer-chasing & TBD & TBD & TBD & TBD & TBD & TBD \\
OpenClawBrain learned & TBD & TBD & TBD & TBD & TBD & TBD \\
\bottomrule
\end{tabular}
\caption{Populate from reproducible runs only. Each \texttt{TBD} must cite commit SHA, command, and artifact path (e.g., \texttt{/tmp/ocb\_eval.json}).}
\end{table}
