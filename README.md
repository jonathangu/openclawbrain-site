...
- Telegram command spine: `/brain codex status`, `/brain codex threads [filter]`, `/brain codex last`, `/brain codex messages`, `/brain codex bind`, `/brain codex tail`, `/brain codex reply`, `/brain codex send`, `/brain codex watches`, `/brain codex unwatch`, and `/brain codex handoff`.
